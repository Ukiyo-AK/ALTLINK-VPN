...
DEFAULT_PLAN_SEEDS = [
    {
        ...
        "device_limit": 6,
        "is_trial": True,
        "description": "Бесплатный доступ на 2 дня с уровнем Pro: все активные серверы и лимит до 6 устройств.",
        "sort_order": 0,
    },
    {
    ...
    },
    {
        ...
        "device_limit": 6,
        "is_trial": False,
        "description": "Полный доступ ко всем активным серверам без ограничений по трафику. Лимит — 6 устройств.",
        "sort_order": 20,
    },
    {
        ...
        "device_limit": 6,
        "is_trial": False,
        "description": "Безлимит на все серверы с еженедельным списанием. В пересчёте на месяц стоит на 30% дороже. Лимит — 6 устройств.",
        "sort_order": 25,
    },
]
